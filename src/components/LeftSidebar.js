...
const UserProfile = () => {
    return <React.Fragment>
        <div className="media user-profile mt-2 mb-2">
            <img src={profilePic} className="avatar-sm rounded-circle mr-2" alt="FarmGear" />
            <img src={profilePic} className="avatar-xs rounded-circle mr-2" alt="FarmGear" />

            <div className="media-body">
                <h6 className="pro-user-name mt-0 mb-0">{getLoggedInUser().name}</h6>
                <span className="pro-user-desc">{getLoggedInUser().username}</span>
            </div>
